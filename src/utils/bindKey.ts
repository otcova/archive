...
export type KeyMap = Letter | `CTRL ${Letter}` | `ALT ${Letter}` | `CTRL ALT ${Letter}`;

type Listener = {
	addEventListener: (type: "keydown", listener: () => void) => void,
	removeEventListener: (type: "keydown", listener: () => void) => void,
}
